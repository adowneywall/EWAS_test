...
simRun <- "SampleData/Output_baboonSim/"
simRange <- ""
simList
sim.data <- readRDS("SampleData/Output_baboonSim/baboonfinal2_Sim1Rep20.Rdata")
X <- sim.data$X.list
Y <- sim.data$Y.list
lfmm.test=T
cate.test=T
...
dSVA.test = T
oracle.test=FALSE
glm.linear.test=FALSE
glm.logistic.test=FALSE
...
binomal.glm.count.test <- function(b=NULL,mc=NULL,tc=NULL,x,lf=NULL,method=1){
  p <- NULL
  z <- NULL
